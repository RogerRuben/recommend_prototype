...
SEEDS = [
    ...
    {"agreement_id": "H-02", "params": {"weight": 6.0, "other": 4.0}, "tags": []},
]
...
def main():
    ...
    ], "indicator_filter_mode": "all", "min_capability": 50, "count": 3, "target_protocol": None}
    result = gen.generate(request, count=3, seed=5, budget=300, search_mode="fast")
    candidates = result.get("candidates") or []
    descendants = [c for c in candidates if (c.get("generation_trace") or {}).get("parent_iteration") is not None]
